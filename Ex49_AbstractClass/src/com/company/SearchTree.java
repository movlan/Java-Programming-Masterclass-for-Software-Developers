...
public class SearchTree implements NodeList {
    ...
    public boolean addItem(ListItem listItem) {
        ...
        // otherwise, start comparing from the head of the three
        ListItem currentItem = this.root;
        while (currentItem != null) {
            int comparison = currentItem.compareTo(listItem);
            if (comparison < 0) {
                // listItem is gerater, move right if possible
                ...
                // listItem is less move to left if possible
    ...
    public boolean removeItem(ListItem listItem) {
        ...
        while (currentItem != null) {
            ...
            if (comparison < 0) {
                ...
                // equal: we've found the listItem so remove it
